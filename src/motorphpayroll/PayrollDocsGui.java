...
public class PayrollDocsGui extends javax.swing.JFrame {
    ...
    public PayrollDocsGui(User user, HomePageGui homePage) {
        ...
        salaryModule = new SalaryCalculationModule(user.getId(), user.getHourlyRate());
        initComponents();
    ...
    private void yearComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_yearComboBoxItemStateChanged
        if (evt.getStateChange() == java.awt.event.ItemEvent.SELECTED) {
            if (yearComboBox.getSelectedItem().equals("Select Year")) return;
    ...
    private void januaryPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_januaryPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("January");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());     
        new PayslipGui(salaryModule, "January", user, overlay).setVisible(true);
    ...
    private void febPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_febPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("February");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "February", user, overlay).setVisible(true);
    ...
    private void marchPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_marchPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("March");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "March", user, overlay).setVisible(true);
    ...
    private void aprilPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_aprilPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("April");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "April", user, overlay).setVisible(true);
    ...
    private void mayPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mayPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("May");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "May", user, overlay).setVisible(true);
    ...
    private void junePayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_junePayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("June");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "June", user, overlay).setVisible(true);
    ...
    private void julyPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_julyPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("July");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "July", user, overlay).setVisible(true);
    ...
    private void augustPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_augustPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("August");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "August", user, overlay).setVisible(true);
    ...
    private void septemberPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_septemberPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("September");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "September", user, overlay).setVisible(true);
    ...
    private void octoberPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_octoberPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("October");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "October", user, overlay).setVisible(true);
    ...
    private void novemberPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_novemberPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("November");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "November", user, overlay).setVisible(true);
    ...
    private void decemberPayslipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_decemberPayslipMouseClicked
        ...
        showOverlay();
        salaryModule.setSelectedMonth("December");
        salaryModule.setSelectedYear(yearComboBox.getSelectedItem().toString());
        new PayslipGui(salaryModule, "December", user, overlay).setVisible(true);
